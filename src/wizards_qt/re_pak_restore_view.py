...
Utils.archives.re_pak_patcher; the repair runs on a daemon thread and marshals log
...
from gui_qt.theme.theme_qt import active_palette, _c, button_qss, err_text
