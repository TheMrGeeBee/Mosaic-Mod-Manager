...
Utils.plugins.plugin_scan_common), and standalone scan/generate/register functions
...
def _read_active_profile(game: "BaseGame") -> str:
    ...
    # 1. Live profile dir set by Mosaic
...
def register_output_mod(game: "BaseGame", mod_name: str, mod_dir: Path, *,
    ...
    Mosaic treats the output as a managed, enabled mod."""
...
def _gen_bos(out_dir: Path, dna_map, mods_path, data_path, is_selected,
    ...
    for plugin_name, dna in dna_map.items():
        ...
        lines = [
            f"; Auto-generated by SkyGen (Mosaic) for {plugin_name}",
